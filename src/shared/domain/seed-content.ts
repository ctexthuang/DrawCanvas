...
export const legacySeedArtworks: ReadonlyArray<GeneratedArtwork> = [
...
export const legacySeedPrompts: ReadonlyArray<PromptAsset> = [
...
export const legacySeedWorkflows: ReadonlyArray<WorkflowAsset> = [
